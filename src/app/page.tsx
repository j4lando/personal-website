...
export default function Home() {
  return (
    ...
    >
      ...
      >
        <Image
          src="/nextjs-github-pages/images/a_storm2.png"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
          ...
          <div className="flex gap-8 mt-2">
            ...
            <a href="/nextjs-github-pages/Josh_Lando_CV.pdf" target="_blank" rel="noopener noreferrer">
              <svg width="40" height="40" viewBox="0 0 24 24" fill={iconColor} xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-80 h-80 rounded-full overflow-hidden shadow-2xl">
              <Image
                src="/nextjs-github-pages/images/cowboy_hat.jpeg"
                alt="Josh Lando"
                fill
